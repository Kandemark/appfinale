package com.application.myapplication.ui.screens.profile
...
import com.application.myapplication.common.CustomAppBar
import com.application.myapplication.common.CustomDefaultBtn
import com.application.myapplication.model.User
import com.application.myapplication.common.ErrorSuggestion
import com.application.myapplication.common.Loading
import com.application.myapplication.util.Resource
import com.application.myapplication.viewmodel.ProfileViewModel
...
fun ProfileScreenContent(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        when (profileState) {
            ...
            is Resource.Failure<*> -> {
                ErrorSuggestion(message = profileState.exception.toString())
            }
